...
export function formatTypesFileHeader(apiVersion: string): string {
  ...
  export const ApiGroup = '${group}';

  export const ApiVersion = '${apiVersion}';
  `;
}

function formatResourceKindExport(resourceName: string) {
  return `export const ${resourceName} = '${resourceName}';
  `;
}

function formatResourceApiVersionExport(
  resourceName: string,
  apiVersion: string
) {
  return `export const ${resourceName}ApiVersion = '${apiVersion}';
  `;
}

export function formatResourceExport(
  resourceNames: IResourceNames,
  apiVersion: string,
  typesData: string
): string {
  return `${formatResourceKindExport(resourceNames.kind)}
${formatResourceApiVersionExport(resourceNames.kind, apiVersion)}
${typesData}
`;
}
...
${formatResourceApiVersionExport(resourceNames.listKind, apiVersion)}
