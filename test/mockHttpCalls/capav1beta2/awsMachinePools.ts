...
export const randomClusterCAPA1AWSMachinePoolSpot: capav1beta2.IAWSMachinePool =
  {
    ...
    metadata: {
      ...
      creationTimestamp: '2022-10-19T09:16:00Z',
      finalizers: [
        'awsmachinepool.infrastructure.cluster.x-k8s.io',
        'capa-iam-operator.finalizers.giantswarm.io/nodes',
      ],
      ...
      labels: {
        ...
        'cluster.x-k8s.io/watch-filter': 'capi',
        'giantswarm.io/cluster': 'asdf1',
        'giantswarm.io/machine-pool': 'asdf1-machine-pool1',
        'giantswarm.io/organization': 'org1',
        'helm.sh/chart': 'cluster-aws-0.9.2',
      },
      name: 'asdf1-machine-pool1',
      namespace: 'org1',
      ownerReferences: [
        {
          apiVersion: 'cluster.x-k8s.io/v1beta1',
    ...
    spec: {
      ...
      awsLaunchTemplate: {
        ami: {},
        iamInstanceProfile: 'nodes-machine-pool1-asdf1',
        imageLookupBaseOS: 'ubuntu-20.04',
        imageLookupFormat: 'capa-ami-{{.BaseOS}}-{{.K8sVersion}}-00-gs',
        imageLookupOrg: '706635527432',
        instanceType: 'm5.xlarge',
        ...
        sshKeyName: '',
        spotMarketOptions: { maxPrice: '0.90' },
      },
      defaultCoolDown: '5m0s',
      maxSize: 10,
      minSize: 3,
    ...
    status: {
      conditions: [
        {
          lastTransitionTime: '2022-10-19T09:22:34Z',
          status: 'True',
          type: 'Ready',
        },
        {
        ...
        {
          lastTransitionTime: '2022-10-19T09:22:33Z',
          status: 'True',
          type: 'LaunchTemplateReady',
        },
      ],
