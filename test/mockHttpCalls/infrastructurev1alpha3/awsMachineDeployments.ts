...
export const randomClusterAWS1AWSMachineDeployment1: infrav1alpha3.IAWSMachineDeployment =
  {
...
// AWSMachineDeployment for randomClusterAWS1's MachineDeploymentList item
export const randomClusterAWS1AWSMachineDeployment2: infrav1alpha3.IAWSMachineDeployment =
  {
    apiVersion: 'infrastructure.giantswarm.io/v1alpha3',
    kind: 'AWSMachineDeployment',
    metadata: {
      ...
      labels: {
        ...
        'cluster.x-k8s.io/cluster-name': 'c7hm5',
        'giantswarm.io/cluster': 'c7hm5',
        'giantswarm.io/machine-deployment': 'f72hf',
        'giantswarm.io/organization': 'org1',
        'release.giantswarm.io/version': '17.2.0',
      },
      name: 'f72hf',
      ...
      resourceVersion: '992723656',
      selfLink:
        '/apis/infrastructure.giantswarm.io/v1alpha3/namespaces/org-org1/awsmachinedeployments/f72hf',
      uid: '140893be-7c92-46f7-a1dd-5d628d45fc1f',
    },
    spec: {
      nodePool: {
