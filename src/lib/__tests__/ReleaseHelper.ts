...
describe('ReleaseHelper', () => {
  ...
  test.each`
    ...
    ${'9.3.0'}         | ${'aws'}   | ${true}           | ${false} | ${'10.0.23'}       | ${false}
    ${'9.3.0'}         | ${'aws'}   | ${true}           | ${true}  | ${'10.0.23'}       | ${false}
    ...
    ${'9.1.0'}         | ${'azure'} | ${true}           | ${false} | ${'9.3.0'}         | ${false}
    ${'9.1.0'}         | ${'azure'} | ${true}           | ${true}  | ${'9.3.0'}         | ${false}
  `(
  ...
  test.each`
    ...
    ${'9.0.0'}         | ${'aws'}   | ${true}           | ${true}  | ${['9.0.1', '9.0.2', '9.0.3', '9.1.0', '9.1.5', '9.2.3', '9.3.0', '10.0.0']}
    ${'9.1.0'}         | ${'aws'}   | ${false}          | ${false} | ${['9.1.5', '9.2.3', '9.2.4-beta3', '9.2.4-beta4', '9.3.0']}
    ${'9.1.0'}         | ${'aws'}   | ${false}          | ${true}  | ${['9.1.5', '9.2.3', '9.2.4-beta3', '9.2.4-beta4', '9.3.0', '10.0.0']}
    ...
    ${'8.0.0'}         | ${'azure'} | ${true}           | ${false} | ${['9.0.3', '9.1.0', '9.1.5', '9.2.3', '9.3.0', '10.0.23', '10.1.0']}
    ${'8.0.0'}         | ${'azure'} | ${true}           | ${true}  | ${['8.0.1', '9.0.0', '9.0.1', '9.0.2', '9.0.3', '9.1.0', '9.1.5', '9.2.3', '9.3.0', '10.0.0', '10.0.23', '10.1.0']}
