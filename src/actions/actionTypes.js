...
export const CLUSTER_CREATE_APP_CONFIG_SUCCESS = 'CLUSTER_CREATE_APP_CONFIG_SUCCESS';
export const CLUSTER_CREATE_APP_CONFIG_ERROR = 'CLUSTER_CREATE_APP_CONFIG_ERROR';

export const CLUSTER_UPDATE_APP_CONFIG = 'CLUSTER_UPDATE_APP_CONFIG';
export const CLUSTER_UPDATE_APP_CONFIG_SUCCESS = 'CLUSTER_UPDATE_APP_CONFIG_SUCCESS';
export const CLUSTER_UPDATE_APP_CONFIG_ERROR = 'CLUSTER_UPDATE_APP_CONFIG_ERROR';

export const CLUSTER_DELETE_APP_CONFIG = 'CLUSTER_DELETE_APP_CONFIG';
export const CLUSTER_DELETE_APP_CONFIG_SUCCESS = 'CLUSTER_DELETE_APP_CONFIG_SUCCESS';
export const CLUSTER_DELETE_APP_CONFIG_ERROR = 'CLUSTER_UPDATE_APP_CONFIG_ERROR';

// Clusters - App Secrets
export const CLUSTER_CREATE_APP_SECRET = 'CLUSTER_CREATE_APP_SECRET';
export const CLUSTER_CREATE_APP_SECRET_SUCCESS = 'CLUSTER_CREATE_APP_SECRET_SUCCESS';
export const CLUSTER_CREATE_APP_SECRET_ERROR = 'CLUSTER_CREATE_APP_SECRET_ERROR';

export const CLUSTER_UPDATE_APP_SECRET = 'CLUSTER_UPDATE_APP_SECRET';
export const CLUSTER_UPDATE_APP_SECRET_SUCCESS = 'CLUSTER_UPDATE_APP_SECRET_SUCCESS';
export const CLUSTER_UPDATE_APP_SECRET_ERROR = 'CLUSTER_UPDATE_APP_SECRET_ERROR';

export const CLUSTER_DELETE_APP_SECRET = 'CLUSTER_DELETE_APP_SECRET';
export const CLUSTER_DELETE_APP_SECRET_SUCCESS = 'CLUSTER_DELETE_APP_SECRET_SUCCESS';
export const CLUSTER_DELETE_APP_SECRET_ERROR = 'CLUSTER_UPDATE_APP_SECRET_ERROR';
...
// Clusters - Node Pools
export const CLUSTERS_LOAD_NODEPOOLS_SUCCESS = 'CLUSTERS_LOAD_NODEPOOLS_SUCCESS';
export const CLUSTERS_LOAD_NODEPOOLS_ERROR = 'CLUSTERS_LOAD_NODEPOOLS_ERROR';

// Node Pools
export const NODEPOOLS_LOAD_SUCCESS = 'NODEPOOLS_LOAD_SUCCESS';
export const NODEPOOLS_LOAD_ERROR = 'NODEPOOLS_LOAD_ERROR';
