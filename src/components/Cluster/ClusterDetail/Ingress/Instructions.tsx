          ...
          <Option
            ...
            footer={
              <>
                ...
                <Text />
                Caution: DNS change propagation may take up to a day, depending
                on the TTL configuration of the DNS entry.
              </>
            }
          >
            <Steps>
          ...
          <Option
            ...
            footer={
              <Text>
                ...
                clients consuming the service can no longer use the known URL
