...
const ListAppCatalogsAndAppsGuide: React.FC<IListAppCatalogsAndAppsGuideProps> =
  ({ ...props }) => {
        ...
        <CLIGuideStepList>
          ...
          >
            ...
            <Text>
              ...
              with the name of the catalog. Add a <code>--namespace</code> flag
              in case your catalog is situated in a namespace other than{' '}
              <code>default</code>.
            </Text>
          </CLIGuideStep>
        </CLIGuideStepList>
