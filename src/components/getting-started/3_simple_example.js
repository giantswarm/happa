    ...
    render() {
      return (
        <Slide>
          ...
          <p>Next use <code>sed</code> to replace the placeholder <code>helloworld.YOUR_CLUSTER_BASE_DOMAIN</code> with <code>{this.helloWorldHost()}</code>.</p>
          <CodeBlock>
            <Prompt>
              {`
                sed -i "" "s/helloworld.YOUR_CLUSTER_BASE_DOMAIN/${this.helloWorldHost()}/" helloworld-manifest.yaml
              `}
            </Prompt>
          </CodeBlock>
